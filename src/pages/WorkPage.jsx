...
export default function WorkPage() {
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', padding: '88px 48px 56px', maxWidth: 1120, margin: '0 auto' }}>
        <Reveal
          style={{
            display: 'inline-flex',
            alignItems: 'center',
        ...
        >
          <span style={{ width: 7, height: 7, borderRadius: '50%', background: '#facd12', boxShadow: '0 0 10px rgba(250,205,18,0.8)' }} />
          <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.85)' }}>Real products, running in production</span>
        </Reveal>
        ...
        <Reveal
          as="p"
          style={{ fontSize: 17, lineHeight: 1.7, color: 'rgba(255,255,255,0.6)', maxWidth: '56ch', margin: '20px 0 0' }}
        >
      ...
      <div style={{ position: 'relative', maxWidth: 1120, margin: '0 auto', padding: '0 48px 96px', display: 'flex', flexDirection: 'column', gap: 64 }}>
        {projects.map((p) => (
